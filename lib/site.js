...
export const services = [
  ...
  },
  {
    ...
    summary:
      "Intuitive digital interfaces and user-centric flows engineered to maximize engagement and retention.",
    detail:
      "We design frictionless digital interfaces that turn complex workflows into intuitive, engaging user experiences. Grounded in user research and behavioral analysis, every screen is structured to guide visitors effortlessly toward conversion.",
    deliverables: [
      "User research, persona mapping, and journey flows",
      "Interactive wireframes and high-fidelity Figma prototypes",
      "Comprehensive design systems and UI component libraries",
      "Usability testing, friction audits, and accessibility review",
      "Developer-ready design tokens and asset handoff",
    ],
  },
  {
    slug: "cro-analytics",
    ...
    summary:
      "Data-driven experimentation and behavioral analytics to turn existing traffic into paying customers.",
    detail:
      "Traffic without conversion is lost revenue. We analyze user clickmaps, session recordings, and funnel metrics to eliminate friction points, executing rigorous A/B experiments that measurably boost inquiries and sales.",
    deliverables: [
      "Conversion funnel teardowns and UX friction auditing",
      "Heatmap, scrollmap, and session recording analysis",
      "A/B multivariate split testing and experiment roadmaps",
      "Checkout and landing page conversion redesigns",
      "Custom analytics dashboards and monthly ROI reporting",
    ],
  },
  {
    slug: "headless-cms",
    ...
    summary:
      "Scalable content architectures and custom API integrations connecting your stack seamlessly.",
    detail:
      "Empower your marketing team to publish content instantly without relying on engineering. We integrate modern headless CMS platforms with custom APIs, webhooks, and third-party tools for total creative control.",
    deliverables: [
      "Bespoke Headless CMS setup (Sanity, Strapi, Contentful)",
      "Custom schema modeling tailored to your team's workflow",
      "Third-party REST & GraphQL API integrations",
      "Automated webhook triggers and real-time content sync",
      "Hands-on editorial training and video documentation",
    ],
  },
];
...
export const clients = [
  { name: "Arabella", industry: "Bio-Architecture", scope: "Living Walls & Facades" },
  { name: "Potters Design", industry: "Luxury Fashion", scope: "E-Commerce & Digital Flagship" },
  { name: "Building Design Workshop", industry: "Architecture & Landscape", scope: "Architectural Web Portal" },
  ...
  { name: "Vantage Logistics", industry: "Supply Chain", scope: "Web Platform & Portal" },
];
...
export const testimonials = [
  {
    ...
    name: "Arabella Leadership",
    role: "Director of Bio-Architecture",
    company: "Arabella",
    service: "Brand Identity & Digital Platform",
  },
  {
    quote:
  ...
  },
  {
    ...
    service: "Full-Stack Development & Portfolio",
  },
];
